...
func updatePrWithCoverageReport(report string) error {
	...
	var coverageFormated = ""
	coverageFormated += coverageCommentDelimiterStart + "\n"
	coverageFormated += "<!-- This field is auto-generated by a workflow, do not edit manually -->" + "\n"
	coverageFormated += report
	coverageFormated += coverageCommentDelimiterEnd
	var body string
	if pr.Body != nil {
		body = *pr.Body
	} else {

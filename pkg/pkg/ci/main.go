		...
		return runLinter(linterArgs{
			...
			jsonInfo: jsonInfos{
				...
				Mappings: jsonToFindingsMappings{
					ToolName:  jsonToFindingsMapping{Key: ".[].Package"},
					RuleID:    jsonToFindingsMapping{Key: ".[].Package"},
					Level:     jsonToFindingsMapping{Key: ".[].Package"},
					FilePath:  jsonToFindingsMapping{Key: ".[].Package"},
					StartLine: jsonToFindingsMapping{Key: ".[].Package"},
					EndLine:   jsonToFindingsMapping{Key: ".[].Package"},
					StartCol:  jsonToFindingsMapping{Key: ".[].Package"},
					EndCol:    jsonToFindingsMapping{Key: ".[].Package"},
					Message:   jsonToFindingsMapping{Key: ".[].Package"},
				},
			},
		})
	default:
